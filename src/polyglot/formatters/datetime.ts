import { PolyglotConfig, Timezone } from "~/polyglot/types/types";

export namespace Datetime {
  export const getTzLabel = () => Intl.DateTimeFormat(undefined).resolvedOptions().timeZone;

  export const getTzOffset = () => new Date().getTimezoneOffset();

  export const getTz = (): Timezone => ({ offset: getTzOffset(), label: getTzLabel() });
